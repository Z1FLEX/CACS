...
DROP TABLE IF EXISTS access_card CASCADE;
DROP TABLE IF EXISTS profile_zone CASCADE;
DROP TABLE IF EXISTS profile CASCADE;
DROP TABLE IF EXISTS day_time_slot CASCADE;
DROP TABLE IF EXISTS schedule_day CASCADE;
DROP TABLE IF EXISTS schedule CASCADE;
DROP TABLE IF EXISTS zone_responsibility CASCADE;
